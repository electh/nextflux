    ...
    return (
      <SidebarContext.Provider value={contextValue}>
        <div
          ...
          className={cn(
            "group/sidebar-wrapper flex min-h-svh w-full has-data-[variant=inset]:bg-content2",
            className,
          )}
          ref={ref}
          {...props}
...
const Sidebar = React.forwardRef(
  ...
  const { isNarrow, state, openMobile, setOpenMobile } = useSidebar();
    ...
    if (collapsible === "none") {
      return (
        <div
          className={cn(
            "flex h-full w-(--sidebar-width) flex-col bg-content2 text-content2-foreground",
            className,
          )}
          ref={ref}
          {...props}
  ...
  if (isNarrow) {
    ...
    return (
      <div
        ref={ref}
        className="group peer hidden sm:block text-content2-foreground"
        data-state={state}
      ...
      >
        ...
        >
          <div
            data-sidebar="sidebar"
            className="flex h-full w-full flex-col group-data-[variant=floating]:rounded-2xl group-data-[variant=floating]:shadow-custom group-data-[variant=floating]:bg-gradient-to-b from-background/70 to-primary-50/20"
          >
            {children}
          </div>
        </div>
...
const SidebarTrigger = React.forwardRef(({ className, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      {...props}
    >
      <PanelLeft className="size-4 text-default-500" />
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "group-data-[collapsible=offcanvas]:translate-x-0 group-data-[collapsible=offcanvas]:after:left-full hover:group-data-[collapsible=offcanvas]:bg-content2",
...
const SidebarInput = React.forwardRef(({ className, ...props }, ref) => {
  return (
    <Input
      ...
      data-sidebar="input"
      className={cn(
        "h-8 w-full bg-content1 shadow-none focus-visible:ring-2 focus-visible:ring-primary",
        className,
      )}
      {...props}
    />
  ...
  ({ className, asChild = false, ...props }, ref) => {
    ...
    return (
      <Comp
        ...
        className={cn(
          "duration-200 flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium text-content2-foreground/70 outline-hidden ring-primary transition-[margin,opa] ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
  ...
  ({ className, asChild = false, ...props }, ref) => {
    ...
    return (
      <Comp
        ...
        className={cn(
          "absolute right-3 top-3.5 flex aspect-square w-5 items-center justify-center rounded-md p-0 text-content2-foreground outline-hidden ring-primary transition-transform hover:bg-default/60 hover:text-content2-foreground focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
  ...
  ({ className, asChild = false, showOnHover = false, ...props }, ref) => {
    ...
    return (
      <Comp
        ...
        className={cn(
          "absolute right-1 top-1.5 flex aspect-square w-5 items-center justify-center rounded-full p-0 text-default-500 outline-hidden ring-primary transition-transform hover:bg-default/60 hover:text-default-500 focus-visible:ring-2 peer-hover/menu-button:text-default-500 [&>svg]:size-4 [&>svg]:shrink-0",
          // Increases the hit area of the button on mobile.
          "after:absolute after:-inset-2 md:after:hidden",
